...
_ = lambda x:x
#from i18n import _
from electrum_ppc.wallet import WalletStorage, Wallet
from electrum_ppc.util import format_satoshis, set_verbosity
from electrum_ppc.bitcoin import is_valid
from electrum_ppc.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-ppc create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-ppc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-ppc setconfig' to change your settings")
        return True
