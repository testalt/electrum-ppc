...
from electrum_ppc.bitcoin import EncodeBase58Check, public_key_to_bc_address, bc_address_to_hash_160
...
from electrum_ppc_gui.qt.util import ok_cancel_buttons, EnterButton
