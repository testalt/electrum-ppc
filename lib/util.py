...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-ppc")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-ppc")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-ppc")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-ppc/"
    else:
...
def appdata_dir():
    """Find the path to the application data directory; add an electrum-ppc folder and return path."""
    if platform.system() == "Windows":
        return os.path.join(os.environ["APPDATA"], "Electrum-ppc")
    elif platform.system() == "Linux":
        return os.path.join(sys.prefix, "share", "electrum-ppc")
    elif (platform.system() == "Darwin" or
          platform.system() == "DragonFly" or
          platform.system() == "OpenBSD" or
          platform.system() == "FreeBSD" or
	  platform.system() == "NetBSD"):
        return "/Library/Application Support/Electrum-ppc"
    else:
