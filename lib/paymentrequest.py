...
REQUEST_HEADERS = {'Accept': 'application/bitcoin-paymentrequest', 'User-Agent': 'Electrum-ppc'}
ACK_HEADERS = {'Content-Type':'application/bitcoin-payment','Accept':'application/bitcoin-paymentack','User-Agent':'Electrum-ppc'}
...
def load_certificates():
    try:
        ...
        print "ca-bundle.crt file should be placed in ~/.electrum-ppc/ca/ca-bundle.crt"
...
class PaymentRequest:
    ...
    def send_ack(self, raw_tx, refund_addr):
        ...
        paymnt.memo = "Paid using Electrum-ppc"
